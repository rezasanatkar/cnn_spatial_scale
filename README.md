...
The goal of this repo and its corresponding blogpost if to provide a deeper insight into the intuitions behind the use cases of multi-scale convolutional
